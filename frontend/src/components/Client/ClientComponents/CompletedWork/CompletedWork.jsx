...
// // import styles from "./CompletedWork.module.css"; // Importing the updated CSS module
...
// //     try {
// //       const response = await ClientService.postRatingsByPostId(postId, rating);
...
// //       } else {
// //         notification.error({
// //           message: "Error uploading ratings",
...
// //       notification.error({
// //         message: "Error",
// //         description: "There was an error submitting ratings",
// //       });
// //     }
// //   };
...
// //       {workImages.length > 0 && (
// //         <div className={styles.completedWorkRatingSection}>
...
//   const [rating, setRating] = useState(0);
//   const [clientFeedback, setClientFeedback] = useState(""); // New state for feedback
//   const { postId, crafterId } = useParams();
//   const navigate = useNavigate();
...
//       const response = await ClientService.getCompletedWork(crafterId, postId);
//       setWorkImages(response.data.imageDetails || []);
//       setCrafterComment(response.data.comment || "");
//     } catch (error) {
//       notification.error({
//         message: "Error",
//         description: "There was an error fetching the completed work images.",
