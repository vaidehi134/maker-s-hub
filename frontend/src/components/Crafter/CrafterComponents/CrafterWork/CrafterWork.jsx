...
const CrafterWork = () => {
  ...
  const handleAcknowledgePayment = async (postId) => {
    navigate(`/crafter/acknowledgedPayment/${crafterId}/${postId}`);
  }
                ...
                {post.postStatus === "PAID" && (
                  <div className={styles.postAction}>
                    {ratings[post.id]?.rating ? (
                      <>
                        <button
                          onClick={() => showReviewModal(post.id)}
                          className={styles.updateButton}
                        >
                          See Reviews
                        </button>
                    ...
                    <button
                      onClick={() => handleAcknowledgePayment(post.id)}
                      className={styles.updateButton}
                    >
                      Acknowledge Payment
                    </button>
